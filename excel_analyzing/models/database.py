...
class WorkbookModel(Base):
    ...
    # Relationships
    sheets = relationship("SheetModel", back_populates="workbook", cascade="all, delete-orphan")
    processing_results = relationship("ProcessingResultModel", back_populates="workbook", cascade="all, delete-orphan")
...
class SheetModel(Base):
    ...
    columns = relationship("ColumnModel", back_populates="sheet", cascade="all, delete-orphan")
    
    def __repr__(self) -> str:
        """String representation of sheet."""
        return f"<SheetModel(id={self.id}, name='{self.name}', workbook_id={self.workbook_id})>"
...
class ColumnModel(Base):
    ...
    def __repr__(self) -> str:
        ...
        return f"<ColumnModel(id={self.id}, name='{self.name}', sheet_id={self.sheet_id})>"
...
class ProcessingResultModel(Base):
    ...
    def __repr__(self) -> str:
        ...
        return f"<ProcessingResultModel(id={self.id}, workbook_id={self.workbook_id}, success={self.success})>"
